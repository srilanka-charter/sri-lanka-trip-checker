...
- [x] メイン地図をheight指定から4:3の縦横比ベースへ変更し、iframe内の高さ伸長を防ぐ
- [x] 代替案の問い合わせボタンでも対応する旅程表をクリップボードへコピーする
- [x] デスクトップ・モバイルで地図の最小高とレイアウトを検証する
- [x] embed=1のときだけルートのmin-h-screenとフォームパネルのsticky・高さ制限を外す
- [x] 通常URLでstickyを維持し、代替案ボタンのコピー処理も再確認する
- [x] 埋め込み・通常表示のPCレイアウトと型検査・単体テストを確認する
- [x] embed=1のときだけ左フォーム内側の上部余白を0にし、通常表示の上部20pxを維持する
- [x] 代替案の問い合わせボタンで対象旅程Markdownをコピーする処理を再確認する
- [x] 埋め込み・通常・モバイル表示と型検査・単体テストを確認する
- [x] フォームから「できたら行きたい場所」入力を削除する
- [x] 「必須で行きたい場所」の表示を「訪れたい場所」へ変更する
- [x] フォーム表示と型検査・単体テストを確認する
